        ...
        <div class="nav-left">
          ...
          <el-menu mode="horizontal" :router="true" :default-active="activeMenu">
            ...
            <el-menu-item index="/cart">
              <el-badge :value="cartStore.count" :hidden="cartStore.count === 0" :offset="[-5, 15]">
                <el-icon>
                  <ShoppingCart />
                </el-icon>
              </el-badge>
            ...
            <el-menu-item index="/order">My Orders</el-menu-item>
          </el-menu>
        </div>

        <!-- Search Box -->
        <div class="search-box">
          <el-input v-model="searchKeyword" placeholder="Search products" clearable @keyup.enter="handleSearch">
            <template #append>
